...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	   ...
	   <div class="full-width-slider">
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(admin/paintingImages/2030.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(admin/paintingImages/5010.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(admin/paintingImages/6020.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="full-width-slider">
			<div class="item" style="background-image: url(admin/paintingImages/1080.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
